[Readme.txt](https://github.com/user-attachments/files/30316760/Readme.txt)
# MOEStock Return Forecasting and Portfolio Construction Using an Event-Conditional Mixture-of-Experts Framework
...
6. Portfolios
   build_books - builds every model x horizon x method x K book.
